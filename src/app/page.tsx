          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              {[
                ...
                { src: '/portfolio/generated-1.png', title: lang === 'bn' ? 'জেনারেটেড আর্ট' : 'Generated Art', category: '🎨 CNC', desc: lang === 'bn' ? 'এআই ডিজাইন' : 'AI Design' },
                { src: '/portfolio/generated-2.png', title: lang === 'bn' ? 'কাস্টম ডিজাইন' : 'Custom Design', category: '🎨 CNC', desc: lang === 'bn' ? 'ব্যক্তিগতকৃত' : 'Personalized' },
                { src: '/portfolio/generated-3.png', title: lang === 'bn' ? 'প্যাটার্ন ডিজাইন' : 'Pattern Design', category: '🎨 CNC', desc: lang === 'bn' ? 'নকশা' : 'Pattern' },
                ...
                { src: '/portfolio/islamic-art-1.png', title: lang === 'bn' ? 'ইসলামিক আর্ট' : 'Islamic Art', category: '🎨 CNC', desc: lang === 'bn' ? 'ধর্মীয় নকশা' : 'Religious Design' },
                { src: '/portfolio/calligraphy-1.png', title: lang === 'bn' ? 'আরবি ক্যালিগ্রাফি' : 'Arabic Calligraphy', category: '🎨 CNC', desc: lang === 'bn' ? 'সুন্দর হস্তলিপি' : 'Beautiful Script' },
              ].map((item, i) => (
