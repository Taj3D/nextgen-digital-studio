...
const translations = {
  bn: {
    common: {
      ...
      engineerTitle: 'যশোরের প্রথম ডিজিটাল ইঞ্জিনিয়ার',
      anotherRequest: 'আরেকটি অনুরোধ পাঠান',
      chatWelcome: 'আসসালামু আলাইকুম! 👋 আমি NextGen Digital Studio এর AI সহায়িকা। আপনাকে কীভাবে সাহায্য করতে পারি?',
      lightMode: 'লাইট মুড',
      darkMode: 'ডার্ক মুড'
    },
    nav: {
    ...
    services: {
      ...
      subtitle: '৮টি ক্যাটাগরিতে ২৫+ প্রিমিয়াম সার্ভিস। ১৭+ বছরের অভিজ্ঞতায় ইঞ্জিনিয়ারিং প্রিসিশনে সেরা ডেলিভারি।',
  ...
  en: {
    common: {
      ...
      engineerTitle: "Jessore's First Digital Engineer",
      anotherRequest: 'Send Another Request',
      chatWelcome: "Hello! 👋 I'm NextGen Digital Studio's AI Assistant. How can I help you?",
    ...
    services: {
      ...
      subtitle: '25+ Premium services in 8 categories. Best delivery with engineering precision from 17+ years of experience.',
...
// Service translations - World-Class Professional Style
const servicesData = {
  bn: [
    {
      icon: '🤖',
      title: 'এআই এজেন্ট',
      description: 'নেক্সট-জেনারেশন AI পাওয়ার্ড বিজনেস অটোমেশন',
      price: '৳৩০,০০০ থেকে',
      features: ['২৪/৭ স্মার্ট চ্যাটবট', 'অর্ডার অটোমেশন', 'লিড ক্যাপচার', 'ভয়েস অ্যাসিস্ট্যান্ট'],
      badge: 'নতুন'
    },
    {
      icon: '📱',
      title: 'মোবাইল অ্যাপ',
      description: 'এন্টারপ্রাইজ-গ্রেড iOS ও Android অ্যাপ',
      price: '৳৫০,০০০ থেকে',
      features: ['ফ্লাটার/React Native', 'পেমেন্ট ইন্টিগ্রেশন', 'রিয়েলটাইম ড্যাশবোর্ড', 'অ্যাপ স্টোর ডিপ্লয়মেন্ট']
    },
    {
      icon: '💻',
      title: 'ওয়েবসাইট',
      description: 'এফিলিয়েট ও বিজনেস ওয়েব সলিউশন',
      price: '৳১৫,০০০ থেকে',
      features: ['ফাস্ট রেসপনসিভ UI', 'SEO রেডি', 'CMS ড্যাশবোর্ড', '১ বছর ফ্রি হোস্টিং']
    },
    {
      icon: '🎨',
      title: '৩ডি সিএনসি ডিজাইন',
      description: 'হাই-প্রিসিশন CNC মাস্টারপিস',
      price: '৳২,০০০ - ৳২০,০০০',
      features: ['৩ডি রিলিফ মডেলিং', 'কাস্টম ফার্নিচার', 'উডেন পোর্ট্রেট', 'প্রোডাকশন-রেডি ফাইল'],
      badge: '১০+ বছর এক্সপার্ট'
    },
    {
      icon: '📱',
      title: 'সোশ্যাল মিডিয়া',
      description: 'ডেটা-ড্রিভেন সোশ্যাল গ্রোথ সলিউশন',
      price: '৳৮,০০০/মাস থেকে',
      features: ['FB/IG স্ট্র্যাটেজি', 'ভাইরাল কনটেন্ট', 'টার্গেটেড অ্যাডস', 'পারফরম্যান্স রিপোর্ট']
    },
    {
      icon: '🎬',
      title: 'ভিডিও প্রোডাকশন',
      description: 'সিনেম্যাটিক ভিডিও কনটেন্ট',
      price: '৳৩,০০০ থেকে',
      features: ['ব্র্যান্ড প্রোমো', 'শর্টফর্ম কনটেন্ট', 'মোশন গ্রাফিক্স', 'প্রো কালার গ্রেডিং']
    },
    {
      icon: '🎨',
      title: 'গ্রাফিক ডিজাইন',
      description: 'স্টানিং ব্র্যান্ড আইডেন্টিটি',
      price: '৳১,৫০০ থেকে',
      features: ['ইউনিক লোগো', 'প্রিন্ট-রেডি কার্ড', 'সোশ্যাল ক্রিয়েটিভ', 'ফুল ব্র্যান্ডিং']
    },
    {
      icon: '📊',
      title: 'ডিজিটাল মার্কেটিং',
      description: 'ROI-ফোকাসড ডিজিটাল গ্রোথ',
      price: '৳৫,০০০/মাস থেকে',
      features: ['টেকনিক্যাল SEO', 'ইমেইল অটোমেশন', 'কনটেন্ট স্ট্র্যাটেজি', 'কনভার্সন অ্যানালিটিক্স']
    }
  ],
  en: [
    {
      icon: '🤖',
      title: 'AI Agent',
      description: 'Next-Generation AI-Powered Business Automation',
      price: 'From ৳30,000',
      features: ['24/7 Smart Chatbot', 'Order Automation', 'Lead Capture', 'Voice Assistant'],
      badge: 'New'
    },
    {
      icon: '📱',
      title: 'Mobile App',
      description: 'Enterprise-Grade iOS & Android Apps',
      price: 'From ৳50,000',
      features: ['Flutter/React Native', 'Payment Integration', 'Realtime Dashboard', 'App Store Deployment']
    },
    {
      icon: '💻',
      title: 'Website',
      description: 'High-Performance Business Web Solutions',
      price: 'From ৳15,000',
      features: ['Fast Responsive UI', 'SEO Ready', 'CMS Dashboard', '1 Year Free Hosting']
    },
    {
      icon: '🎨',
      title: '3D CNC Design',
      description: 'High-Precision CNC Masterpieces',
      price: '৳2,000 - ৳20,000',
      features: ['3D Relief Modeling', 'Custom Furniture', 'Wooden Portraits', 'Production-Ready Files'],
      badge: '10+ Years Expert'
    },
    {
      icon: '📱',
      title: 'Social Media',
      description: 'Data-Driven Social Growth Solutions',
      price: 'From ৳8,000/month',
      features: ['FB/IG Strategy', 'Viral Content', 'Targeted Ads', 'Performance Reports']
    },
    {
      icon: '🎬',
      title: 'Video Production',
      description: 'Cinematic Video Content Creation',
      price: 'From ৳3,000',
      features: ['Brand Promos', 'Short-Form Content', 'Motion Graphics', 'Pro Color Grading']
    },
    {
      icon: '🎨',
      title: 'Graphic Design',
      description: 'Stunning Brand Identity Design',
      price: 'From ৳1,500',
      features: ['Unique Logos', 'Print-Ready Cards', 'Social Creatives', 'Full Branding']
    },
    {
      icon: '📊',
      title: 'Digital Marketing',
      description: 'ROI-Focused Digital Growth',
      price: 'From ৳5,000/month',
      features: ['Technical SEO', 'Email Automation', 'Content Strategy', 'Conversion Analytics']
    }
  ]
};
...
export default function Home() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'assistant', content: common.chatWelcome }
  ]);
  ...
  // Theme state with localStorage persistence - initialize with system preference
  const [theme, setTheme] = useState<'dark' | 'light'>(() => {
    // Only runs on client
    if (typeof window !== 'undefined') {
      const saved = localStorage.getItem('nextgen-theme') as 'dark' | 'light' | null;
  ...
  const handleAdminLogin = () => {
    ...
    if (adminPassword === ADMIN_PASSWORD) {
      ...
      setAdminError(lang === 'bn' ? 'ভুল পাসওয়ার্ড!' : 'Wrong password!');
    }
  };
  ...
  const handleFormSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Optional: Open WhatsApp with lead info for immediate notification
        if (data.whatsappLink) {
          // Uncomment below to auto-open WhatsApp
          // window.open(data.whatsappLink, '_blank');
          console.log('Lead submitted. WhatsApp link:', data.whatsappLink);
        }
      } else {
        // Show error message to user
        alert(data.message || (lang === 'bn' ? 'সাবমিশনে সমস্যা হয়েছে। WhatsApp এ যোগাযোগ করুন।' : 'Submission failed. Please contact via WhatsApp.'));
      }
    } catch (error) {
      console.error('Form submission error:', error);
      alert(lang === 'bn' ? 'সাবমিশনে সমস্যা হয়েছে। WhatsApp এ যোগাযোগ করুন: +8801711731354' : 'Submission failed. Contact via WhatsApp: +8801711731354');
    }
  ...
  if (loading) {
    return (
      <div className={`fixed inset-0 z-[99999] flex items-center justify-center ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`} role="status" aria-label={common.loading}>
        <div className="text-center">
          ...
          <div className={`w-64 md:w-80 h-2 ${theme === 'dark' ? 'bg-[#333]' : 'bg-gray-200'} rounded-full overflow-hidden`}>
            <div 
              className="h-full bg-gradient-to-r from-cyan-400 to-yellow-400 transition-all duration-300"
              style={{ width: `${Math.min(loadingProgress, 100)}%` }}
            />
          </div>
          <p className="text-gray-400 mt-4">{common.loading}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-gray-50'}`}>
      ...
      {/* Navigation */}
      <nav 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? `${theme === 'dark' ? 'bg-[#0a0a0a]/95' : 'bg-white/95'} backdrop-blur-md shadow-lg ${theme === 'dark' ? 'shadow-cyan-500/10' : 'shadow-gray-200'}` : 'bg-transparent'}`}
        role="navigation"
      ...
      >
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <a href="#home" className="flex items-center gap-3 group" aria-label="NextGen Digital - হোম">
              ...
              <div className="hidden sm:block">
                <span className={`text-lg md:text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>NextGen <span className="text-cyan-400">Digital</span></span>
                <p className="text-[10px] text-gray-400 -mt-1">{common.engineerTitle}</p>
              </div>
            </a>
            
            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center gap-8">
              <a href="#services" className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 transition-colors`}>{t.nav.services}</a>
              <a href="#pricing" className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 transition-colors`}>{t.nav.pricing}</a>
              <a href="#about" className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 transition-colors`}>{t.nav.about}</a>
              <a href="#contact" className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 transition-colors`}>{t.nav.contact}</a>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={toggleTheme}
                className={`p-2 rounded-lg ${theme === 'dark' ? 'bg-[#1a1a1a] border-[#333]' : 'bg-gray-100 border-gray-200'} border text-sm font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-700'} hover:border-cyan-500/50 transition-colors flex items-center gap-1.5`}
                aria-label={theme === 'dark' ? common.lightMode : common.darkMode}
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg ${theme === 'dark' ? 'bg-[#1a1a1a] border-[#333]' : 'bg-gray-100 border-gray-200'} border text-sm font-medium ${theme === 'dark' ? 'text-white' : 'text-gray-700'} hover:border-cyan-500/50 transition-colors flex items-center gap-1.5`}
        ...
        <div 
          ...
          role="menu"
        >
          <div className={`${theme === 'dark' ? 'bg-[#0a0a0a]/95' : 'bg-white/95'} backdrop-blur-md border-t ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} px-4 py-4 space-y-2`}>
            <a href="#services" onClick={() => setMobileMenuOpen(false)} className={`block py-3 px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 hover:bg-cyan-400/10 rounded-lg transition-colors`} role="menuitem">{t.nav.services}</a>
            <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className={`block py-3 px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 hover:bg-cyan-400/10 rounded-lg transition-colors`} role="menuitem">{t.nav.pricing}</a>
            <a href="#about" onClick={() => setMobileMenuOpen(false)} className={`block py-3 px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 hover:bg-cyan-400/10 rounded-lg transition-colors`} role="menuitem">{t.nav.about}</a>
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className={`block py-3 px-4 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} hover:text-cyan-400 hover:bg-cyan-400/10 rounded-lg transition-colors`} role="menuitem">{t.nav.contact}</a>
            <button 
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-20">
        <Particles />
        <div className={`absolute inset-0 bg-gradient-to-b from-transparent via-${theme === 'dark' ? '[#0a0a0a]' : 'gray-100'}/50 to-${theme === 'dark' ? '[#0a0a0a]' : 'gray-50'} z-10`} />
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className={`text-4xl md:text-6xl lg:text-7xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-6 animate-fade-in-up`}>
            {t.hero.title}{' '}
          ...
          <div className={`text-xl md:text-2xl lg:text-3xl ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-8 h-10 animate-fade-in-up`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <Button asChild size="lg" className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 text-black font-semibold text-lg px-8 py-6 rounded-xl shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all">
              <a href="#contact">
                {t.hero.cta1}
                <ChevronRight className="w-5 h-5 ml-2" aria-hidden="true" />
              </a>
            </Button>
            <Button asChild size="lg" variant="outline" className={`border-green-500 text-green-500 hover:bg-green-500 hover:text-white font-semibold text-lg px-8 py-6 rounded-xl gap-2`}>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            {[
              ...
              <div key={i} className={`p-4 md:p-6 rounded-2xl ${theme === 'dark' ? 'bg-[#141414]/80' : 'bg-white'} backdrop-blur border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} hover:border-cyan-500/50 transition-all group`}>
                ...
                <div className={`text-2xl md:text-4xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{stat.value}</div>
      ...
      <main id="main-content">
        ...
        <section id="about" className="py-16 md:py-24 relative" aria-labelledby="about-heading">
          <div className={`absolute inset-0 bg-gradient-to-b ${theme === 'dark' ? 'from-[#0a0a0a] via-[#0f1419] to-[#0a0a0a]' : 'from-gray-50 via-white to-gray-50'}`} />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 id="about-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="flex justify-center mb-12">
              <div className="relative group">
                ...
                <div className={`relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-cyan-500/30 group-hover:border-cyan-500/50 transition-colors ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-100'}`}>
            ...
            <div className="max-w-3xl mx-auto">
              <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-6 text-center`}>{t.about.timeline_title}</h3>
              <div className="space-y-4">
                {timeline.map((item, i) => (
                  <div key={i} className="flex items-center gap-4 group">
                    ...
                    <div className={`flex-1 p-4 rounded-xl ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} group-hover:border-cyan-500/50 transition-all`}>
                      <div className="flex items-center gap-2 mb-1">
                        <item.icon className="w-4 h-4 text-cyan-400" aria-hidden="true" />
                        <span className={`font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{item.title}</span>
                      </div>
            ...
            <div className="mt-12 flex flex-wrap gap-4 justify-center">
              <Button asChild className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 text-black font-semibold">
                <a href="#contact">
                  {t.about.cta1}
                </a>
              </Button>
              <Button asChild variant="outline" className={`border-cyan-500 text-cyan-400 hover:bg-cyan-500/10`}>
                <a href="#services">
                  {t.about.cta2}
                </a>
              </Button>
        ...
        {/* Services Section */}
        <section id="services" className={`py-16 md:py-24 ${theme === 'dark' ? '' : 'bg-gray-50'}`} aria-labelledby="services-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-cyan-500/20 text-cyan-400 mb-4">{t.services.badge}</Badge>
              <h2 id="services-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.map((service, i) => (
                <Card key={i} className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'} hover:border-cyan-500/50 transition-all duration-300 group overflow-hidden`}>
                  <CardContent className="p-6">
                    ...
                    <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2 group-hover:text-cyan-400 transition-colors`}>
                      {service.title}
                    </h3>
            ...
            <div className="text-center mt-12">
              <Button asChild size="lg" className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 text-black font-semibold px-8 py-6 text-lg rounded-xl shadow-lg shadow-cyan-500/25">
                <a href="#contact">
                  {t.services.cta}
                  <ChevronRight className="w-5 h-5 ml-2" aria-hidden="true" />
                </a>
        ...
        <section id="portfolio" className={`py-16 md:py-24 bg-gradient-to-b ${theme === 'dark' ? 'from-[#0a0a0a] via-[#0f1419] to-[#0a0a0a]' : 'from-gray-50 via-white to-gray-50'}`} aria-labelledby="portfolio-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-yellow-500/20 text-yellow-400 mb-4">{t.portfolio.badge}</Badge>
              <h2 id="portfolio-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              {[
                ...
                { src: '/portfolio/cnc-work-3.png', title: lang === 'bn' ? 'সিএনসি মেশিন' : 'CNC Machine', category: '🎨 CNC', desc: lang === 'bn' ? 'প্রেসিশন কাটিং' : 'Precision Cutting' },
                ...
                // 🖼️ Portrait Art
                { src: '/portfolio/portrait-2.png', title: lang === 'bn' ? 'পোর্ট্রেট আর্ট' : 'Portrait Art', category: '🖼️ Portrait', desc: lang === 'bn' ? 'কাঠে খোদাই' : 'Wood Carved' },
                { src: '/portfolio/portrait-3-new.png', title: lang === 'bn' ? 'মেমোরিয়াল আর্ট' : 'Memorial Art', category: '🖼️ Portrait', desc: lang === 'bn' ? 'ব্যক্তিগত স্মৃতি' : 'Personal Memory' },
                { src: '/portfolio/portrait-1.png', title: lang === 'bn' ? 'লেজার পোর্ট্রেট' : 'Laser Portrait', category: '🖼️ Portrait', desc: lang === 'bn' ? 'ব্যক্তিগত ছবি' : 'Personal Photo' },
                // 🏛️ 3D Design
                { src: '/portfolio/generated-1.png', title: lang === 'bn' ? '৩ডি ডিজাইন' : '3D Design', category: '🏛️ 3D', desc: lang === 'bn' ? 'মডার্ন ডিজাইন' : 'Modern Design' },
                { src: '/portfolio/3d-design-3.png', title: lang === 'bn' ? '৩ডি মডেলিং' : '3D Modeling', category: '🏛️ 3D', desc: lang === 'bn' ? 'প্রফেশনাল' : 'Professional' },
                { src: '/portfolio/relief-1.png', title: lang === 'bn' ? '৩ডি রিলিফ' : '3D Relief', category: '🏛️ 3D', desc: lang === 'bn' ? 'গভীর খোদাই' : 'Deep Carving' },
                // 🕌 Islamic Art
                ...
                { src: '/portfolio/islamic-3.png', title: lang === 'bn' ? 'জিওমেট্রিক প্যাটার্ন' : 'Geometric Pattern', category: '🕌 Islamic', desc: lang === 'bn' ? 'ঐতিহ্যবাহী' : 'Traditional' },
                // ✍️ Arabic Calligraphy
                { src: '/portfolio/calligraphy-2.png', title: lang === 'bn' ? 'আরবি ক্যালিগ্রাফি' : 'Arabic Calligraphy', category: '✍️ Calligraphy', desc: lang === 'bn' ? 'সুন্দর হস্তলিপি' : 'Beautiful Script' },
                { src: '/portfolio/calligraphy-3.png', title: lang === 'bn' ? 'ইসলামিক লিপি' : 'Islamic Script', category: '✍️ Calligraphy', desc: lang === 'bn' ? 'ঐতিহ্যবাহী শিল্প' : 'Traditional Art' },
                { src: '/portfolio/calligraphy-1.png', title: lang === 'bn' ? 'ক্যালিগ্রাফি আর্ট' : 'Calligraphy Art', category: '✍️ Calligraphy', desc: lang === 'bn' ? 'শিল্পকলা' : 'Artwork' },
                // 🤖 AI Art
                { src: '/portfolio/generated-2.png', title: lang === 'bn' ? 'এআই আর্ট' : 'AI Art', category: '🤖 AI', desc: lang === 'bn' ? 'জেনারেটেড আর্ট' : 'Generated Art' },
                { src: '/portfolio/ai-art-3.png', title: lang === 'bn' ? 'এআই ক্রিয়েশন' : 'AI Creation', category: '🤖 AI', desc: lang === 'bn' ? 'নিউরাল নেটওয়ার্ক' : 'Neural Network' },
                // 🎨 Digital Art
                { src: '/portfolio/generated-3.png', title: lang === 'bn' ? 'ডিজিটাল আর্ট' : 'Digital Art', category: '🎨 Digital', desc: lang === 'bn' ? 'প্রফেশনাল' : 'Professional' },
                { src: '/portfolio/digital-art-3.png', title: lang === 'bn' ? 'ডিজিটাল ইলাস্ট্রেশন' : 'Digital Illustration', category: '🎨 Digital', desc: lang === 'bn' ? 'ক্রিয়েটিভ' : 'Creative' },
                // 🎁 Personalized Gift
                { src: '/portfolio/gift-2.png', title: lang === 'bn' ? 'পার্সোনালাইজড গিফট' : 'Personalized Gift', category: '🎁 Gift', desc: lang === 'bn' ? 'কাস্টম এনগ্রেভিং' : 'Custom Engraving' },
                { src: '/portfolio/gift-1.png', title: lang === 'bn' ? 'কাস্টম গিফট' : 'Custom Gift', category: '🎁 Gift', desc: lang === 'bn' ? 'বিশেষ উপহার' : 'Special Present' },
                // 🎨 Creative Design
                { src: '/portfolio/design-1.png', title: lang === 'bn' ? 'ক্রিয়েটিভ ডিজাইন' : 'Creative Design', category: '🎨 Creative', desc: lang === 'bn' ? 'ইউনিক আর্ট' : 'Unique Art' },
                { src: '/portfolio/generated-4.png', title: lang === 'bn' ? 'আর্টিস্টিক ডিজাইন' : 'Artistic Design', category: '🎨 Creative', desc: lang === 'bn' ? 'ক্রিয়েটিভ' : 'Creative' },
                // 📱 Social Media
                { src: '/portfolio/generated-5.png', title: lang === 'bn' ? 'সোশ্যাল মিডিয়া' : 'Social Media', category: '📱 Social', desc: lang === 'bn' ? 'মার্কেটিং ড্যাশবোর্ড' : 'Marketing Dashboard' },
                { src: '/portfolio/social-media-3.png', title: lang === 'bn' ? 'সোশ্যাল কনটেন্ট' : 'Social Content', category: '📱 Social', desc: lang === 'bn' ? 'কনটেন্ট ক্রিয়েশন' : 'Content Creation' },
                // 💻 Web Design
                { src: '/portfolio/jan-image-1.png', title: lang === 'bn' ? 'ওয়েব ডিজাইন' : 'Web Design', category: '💻 Web', desc: lang === 'bn' ? 'মডার্ন UI' : 'Modern UI' },
                // 📊 Marketing
                { src: '/portfolio/jan-image-2.png', title: lang === 'bn' ? 'ডিজিটাল মার্কেটিং' : 'Digital Marketing', category: '📊 Marketing', desc: lang === 'bn' ? 'অ্যানালিটিক্স' : 'Analytics' },
                // 🎬 Video
                { src: '/portfolio/cnc-design-1.png', title: lang === 'bn' ? 'ভিডিও এডিট' : 'Video Edit', category: '🎬 Video', desc: lang === 'bn' ? 'প্রফেশনাল' : 'Professional' },
                // 🪑 Furniture
                ...
                <div key={i} className={`group relative aspect-square rounded-xl overflow-hidden ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} hover:border-cyan-500/50 transition-all cursor-pointer`} onClick={() => setPortfolioItem({ src: item.src, title: item.title })}>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
              {portfolioCategories.map((cat, i) => (
                <div key={i} className={`p-4 rounded-xl bg-gradient-to-br ${cat.color} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} text-center`}>
                  <div className="text-2xl mb-2">{cat.icon}</div>
                  <h4 className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold text-sm`}>{cat.title}</h4>
        ...
        <section id="why-us" className={`py-16 md:py-24 ${theme === 'dark' ? '' : 'bg-gray-50'}`} aria-labelledby="why-us-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-cyan-500/20 text-cyan-400 mb-4">{t.whyUs.badge}</Badge>
              <h2 id="why-us-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {whyUs.map((item, i) => (
                <div key={i} className={`text-center p-6 rounded-2xl ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} hover:border-cyan-500/50 transition-all group`}>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-6">
              {trustBadges.map((badge, i) => (
                <div key={i} className={`px-4 py-2 rounded-full ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} text-sm`}>
                  {badge}
                </div>
              ))}
            </div>
        ...
        <section id="testimonials" className={`py-16 md:py-24 bg-gradient-to-b ${theme === 'dark' ? 'from-[#0a0a0a] via-[#0f1419] to-[#0a0a0a]' : 'from-gray-50 via-white to-gray-50'}`} aria-labelledby="testimonials-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-yellow-500/20 text-yellow-400 mb-4">{t.testimonials.badge}</Badge>
              <h2 id="testimonials-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((testimonial, i) => (
                <Card key={i} className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'} hover:border-cyan-500/50 transition-all`}>
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold`}>{testimonial.name}</div>
        ...
        {/* FAQ Section */}
        <section id="faq" className={`py-16 md:py-24 ${theme === 'dark' ? '' : 'bg-gray-50'}`} aria-labelledby="faq-heading">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-cyan-500/20 text-cyan-400 mb-4">{t.faq.badge}</Badge>
              <h2 id="faq-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="space-y-4">
              {faq.map((item, i) => (
                <details key={i} className={`group ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} rounded-xl overflow-hidden`}>
                  <summary className={`flex items-center justify-between p-5 cursor-pointer ${theme === 'dark' ? 'hover:bg-[#1a1a1a]' : 'hover:bg-gray-50'} transition-colors`}>
                    <span className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold pr-4`}>{item.q}</span>
                    <ChevronDown className="w-5 h-5 text-cyan-400 group-open:rotate-180 transition-transform flex-shrink-0" aria-hidden="true" />
                  </summary>
                  <div className={`px-5 pb-5 text-gray-400 text-sm leading-relaxed border-t ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    {item.a}
                  </div>
                </details>
              ))}
            ...
            <div className="text-center mt-10 p-6 rounded-2xl bg-gradient-to-r from-cyan-500/10 to-yellow-500/10 border border-cyan-500/30">
              <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>{t.faq.stillQuestions}</p>
              <Button asChild className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white font-semibold">
                <a href="https://wa.me/8801711731354" target="_blank" rel="noopener noreferrer">
        ...
        {/* Pricing Section */}
        <section id="pricing" className={`py-16 md:py-24 bg-gradient-to-b ${theme === 'dark' ? 'from-[#0a0a0a] via-[#0f1419] to-[#0a0a0a]' : 'from-gray-50 via-white to-gray-50'}`} aria-labelledby="pricing-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-yellow-500/20 text-yellow-400 mb-4">{t.pricing.badge}</Badge>
              <h2 id="pricing-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {pricingPackages.map((pkg, i) => (
                <Card 
                  key={i} 
                  className={`relative ${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'} transition-all duration-300 ${
                    pkg.popular 
                ...
                >
                  ...
                  <CardContent className="p-6 md:p-8">
                    ...
                    <h3 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>{pkg.name}</h3>
                    ...
                    <Button asChild
                      className={`w-full ${
                        pkg.popular 
                          ...
                          : `${theme === 'dark' ? 'bg-[#333] hover:bg-[#444]' : 'bg-gray-200 hover:bg-gray-300'} text-white`
                      }`}
                    >
                      <a href="#contact">
            ...
            <div className="mt-16 p-6 md:p-8 rounded-2xl bg-gradient-to-r from-yellow-500/10 via-orange-500/10 to-yellow-500/10 border border-yellow-500/30">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                  ...
                  <h3 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>{lang === 'bn' ? '৩ডি সিএনসি ডিজাইন' : '3D CNC Design'}</h3>
                ...
                <Button asChild className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-400 hover:to-orange-400 text-black font-semibold">
        ...
        {/* Contact Section */}
        <section id="contact" className={`py-16 md:py-24 ${theme === 'dark' ? '' : 'bg-gray-50'}`} aria-labelledby="contact-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <Badge className="bg-cyan-500/20 text-cyan-400 mb-4">{t.contact.badge}</Badge>
              <h2 id="contact-heading" className={`text-3xl md:text-4xl lg:text-5xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-cyan-500/10 to-yellow-500/10 border border-cyan-500/30">
                  ...
                  <div>
                    <h3 className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-bold text-lg`}>{lang === 'bn' ? 'ইঞ্জিনিয়ার মোঃ নাজমুল ইসলাম তাজ' : 'Engineer Md. Nazmul Islam Taj'}</h3>
                ...
                <div className="p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <strong className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>⏰ {t.contact.responseTime}</strong>
                ...
                {[
                  ...
                  <div key={i} className={`flex items-start gap-4 p-4 rounded-xl ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} hover:border-cyan-500/50 transition-all group`}>
                    ...
                    <div>
                      ...
                      {item.link ? (
                        <a href={item.link} className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold hover:text-cyan-400 transition-colors`}>
                          {item.value}
                        </a>
                      ) : (
                        <div className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold`}>{item.value}</div>
                      )}
                    </div>
                  </div>
                ))}
              ...
              {/* Contact Form */}
              <Card className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'}`}>
                <CardContent className="p-6 md:p-8">
                  {formSuccess ? (
                    <div className="text-center py-12">
                      ...
                      <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>{t.contact.form.success}</h3>
                      <p className="text-gray-400 mb-6">{t.contact.form.successNote}</p>
                      <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Button asChild className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white">
                          <a href="https://wa.me/8801711731354" target="_blank" rel="noopener noreferrer">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4" noValidate>
                      <div>
                        ...
                        <Input
                          ...
                          className={`${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500 ${formErrors.name ? 'border-red-500' : ''}`}
                      ...
                      <div>
                        <Label htmlFor="mobile" className="text-gray-300">{t.contact.form.mobile} *</Label>
                        <Input
                          id="mobile"
                          value={formData.mobile}
                          onChange={(e) => { setFormData({ ...formData, mobile: e.target.value }); setFormErrors({ ...formErrors, mobile: undefined }); }}
                          className={`${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500 ${formErrors.mobile ? 'border-red-500' : ''}`}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          className={`${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500 ${formErrors.email ? 'border-red-500' : ''}`}
                      ...
                      <div>
                        <Label htmlFor="service" className="text-gray-300">{t.contact.form.service} *</Label>
                        <Select value={formData.service} onValueChange={(value) => { setFormData({ ...formData, service: value }); setFormErrors({ ...formErrors, service: undefined }); }}>
                          <SelectTrigger className={`${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500 ${formErrors.service ? 'border-red-500' : ''}`} aria-invalid={!!formErrors.service}>
                            <SelectValue placeholder={t.contact.form.selectService} />
                          </SelectTrigger>
                          <SelectContent className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'}`}>
                            {services.map((s, i) => (
                              <SelectItem key={i} value={s.title} className={`${theme === 'dark' ? 'text-white hover:bg-[#333]' : 'text-gray-900 hover:bg-gray-100'}`}>
                                {s.icon} {s.title}
                              </SelectItem>
                            ))}
                          </SelectContent>
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          className={`${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500 min-h-[100px]`}
      ...
      {/* Footer */}
      <footer className={`py-12 ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-gray-50'} border-t ${theme === 'dark' ? 'border-[#222]' : 'border-gray-200'}`} role="contentinfo">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <span className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>NextGen <span className="text-cyan-400">Digital</span></span>
                  <p className="text-xs text-gray-400">{common.engineerTitle}</p>
                </div>
              </div>
            ...
            {/* Quick Links */}
            <div>
              <h4 className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold mb-4`}>{t.footer.quickLinks}</h4>
              <ul className="space-y-2">
                <li><a href="#services" className="text-gray-400 hover:text-cyan-400 transition-colors">{t.nav.services}</a></li>
                <li><a href="#pricing" className="text-gray-400 hover:text-cyan-400 transition-colors">{t.nav.pricing}</a></li>
                <li><a href="#about" className="text-gray-400 hover:text-cyan-400 transition-colors">{t.nav.about}</a></li>
                <li><a href="#contact" className="text-gray-400 hover:text-cyan-400 transition-colors">{t.nav.contact}</a></li>
              </ul>
            </div>

            {/* Policies */}
            <div>
              <h4 className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-semibold mb-4`}>{t.footer.policies}</h4>
              <ul className="space-y-2">
                <li>
          ...
          <div className={`pt-8 border-t ${theme === 'dark' ? 'border-[#222]' : 'border-gray-200'} text-center`}>
      ...
      <Dialog open={!!policyModal} onOpenChange={() => setPolicyModal(null)}>
        <DialogContent className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-white border-gray-200'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} max-w-lg`}>
          {policyModal && (
            <>
              <DialogHeader>
      ...
      <button
        ...
        aria-label={lang === 'bn' ? 'উপরে যান' : 'Go to top'}
      >
      ...
      <button
        ...
        className={`fixed bottom-44 right-6 z-50 w-12 h-12 rounded-full ${theme === 'dark' ? 'bg-[#1a1a1a]' : 'bg-gray-200'} ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} shadow-lg flex items-center justify-center transition-all hover:scale-110 hover:text-cyan-400 border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-300'}`}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {chatOpen && (
          <div className={`absolute bottom-20 right-0 w-[350px] max-w-[calc(100vw-3rem)] rounded-2xl ${theme === 'dark' ? 'bg-[#141414]' : 'bg-white'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4`} role="dialog" aria-label={t.chat.title}>
            {/* Chat Header */}
            <div className="bg-gradient-to-r from-cyan-500 to-cyan-600 p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-black">NextGen {t.chat.title}</div>
            ...
            <div className="h-80 overflow-y-auto p-4 space-y-4" role="log" aria-live="polite">
                ...
                <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[80%] p-3 rounded-2xl whitespace-pre-wrap ${
                    msg.role === 'user' 
                      ...
                      : `${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-gray-100'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} rounded-bl-sm`
                  }`}>
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className={`${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-gray-100'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'} p-3 rounded-2xl rounded-bl-sm`}>
                    <div className="flex gap-1" aria-label={common.typing}>
            ...
            <div className={`p-4 border-t ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
              ...
              >
                <Input
                  ...
                  className={`flex-1 ${theme === 'dark' ? 'bg-[#0a0a0a] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'} focus:border-cyan-500`}
                  aria-label={lang === 'bn' ? 'চ্যাট মেসেজ' : 'Chat message'}
                />
                <Button 
                  type="submit" 
                  size="icon" 
        ...
        <Button
          ...
          className={`w-14 h-14 rounded-full shadow-lg ${
            chatOpen 
              ? `${theme === 'dark' ? 'bg-[#333] hover:bg-[#444]' : 'bg-gray-300 hover:bg-gray-400'}` 
          ...
          aria-label={chatOpen ? t.chat.closeLabel : t.chat.openLabel}
      ...
      <a
        ...
        aria-label={lang === 'bn' ? 'WhatsApp এ যোগাযোগ করুন' : 'Contact on WhatsApp'}
      >
      ...
      <Dialog open={showInstallModal} onOpenChange={setShowInstallModal}>
        <DialogContent className={`max-w-sm ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-white'} ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
          <DialogHeader>
            <DialogTitle className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} text-center text-lg`}>
            ...
            {isIOS ? (
              <>
                ...
                <div className="space-y-3 text-sm">
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    ...
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? 'শেয়ার বাটনে ট্যাপ করুন' : 'Tap Share Button'}</p>
                  ...
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    ...
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? '"হোম স্ক্রিনে যোগ করুন" নির্বাচন করুন' : 'Select "Add to Home Screen"'}</p>
                      <p className="text-gray-400 text-xs mt-1">
                  ...
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    ...
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? '"যোগ" এ ট্যাপ করুন' : 'Tap "Add"'}</p>
              ...
              <>
                ...
                <div className="space-y-3 text-sm">
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-cyan-500 text-white text-xs flex items-center justify-center font-bold">১</span>
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? 'ব্রাউজার মেনু খুলুন' : 'Open Browser Menu'}</p>
                  ...
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-cyan-500 text-white text-xs flex items-center justify-center font-bold">২</span>
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? '"অ্যাপ ইনস্টল করুন" বা "Add to Home Screen" নির্বাচন করুন' : 'Select "Install App" or "Add to Home Screen"'}</p>
                    </div>
                  </div>
                  <div className={`flex items-start gap-3 p-3 rounded-lg ${theme === 'dark' ? 'bg-[#141414]' : 'bg-gray-50'} border ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-cyan-500 text-white text-xs flex items-center justify-center font-bold">৩</span>
                    <div>
                      <p className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} font-medium`}>{lang === 'bn' ? '"ইনস্টল" এ ট্যাপ করুন' : 'Tap "Install"'}</p>
                      <p className="text-gray-400 text-xs mt-1">{lang === 'bn' ? 'অ্যাপ আপনার হোম স্ক্রিনে যোগ হবে!' : 'App will be added to your home screen!'}</p>
                    </div>
                  </div>
                </div>
      ...
      {portfolioItem && (
        <Dialog open={!!portfolioItem} onOpenChange={() => setPortfolioItem(null)}>
          <DialogContent className={`max-w-4xl ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-white'} ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
            <DialogHeader>
              <DialogTitle className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>{portfolioItem.title}</DialogTitle>
            ...
            <div className="flex gap-4 mt-4">
              ...
              <Button variant="outline" onClick={() => setPortfolioItem(null)} className={`flex-1 ${theme === 'dark' ? 'border-[#333]' : 'border-gray-300'} ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} ${theme === 'dark' ? 'hover:bg-[#1a1a1a]' : 'hover:bg-gray-100'}`}>
                বন্ধ করুন
              </Button>
            </div>
          </DialogContent>
        ...
        <DialogContent className={`max-w-sm ${theme === 'dark' ? 'bg-[#0a0a0a]' : 'bg-white'} ${theme === 'dark' ? 'border-[#333]' : 'border-gray-200'}`}>
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">
              {lang === 'bn' ? 'অ্যাডমিন প্যানেলে প্রবেশ করতে পাসওয়ার্ড দিন' : 'Enter password to access admin panel'}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 pt-4">
            <div className="text-center mb-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center mb-3">
            ...
            <Input
              ...
              className={`${theme === 'dark' ? 'bg-[#141414] border-[#333]' : 'bg-gray-50 border-gray-300'} ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}
            ...
            <div className="flex gap-3">
              <Button 
                ...
                className={`flex-1 ${theme === 'dark' ? 'border-[#333]' : 'border-gray-300'} ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}
              >
