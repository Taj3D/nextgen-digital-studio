...
export const PDF_TOOLS: PdfTool[] = [
  ...
  },
  {
    ...
    descEn: 'Read and preview any PDF instantly.',
    descBn: 'যেকোনো পিডিএফ দ্রুত পড়ুন ও দেখুন।',
    category: 'popular',
    icon: '👁️',
    functional: false,
    comingSoon: true,
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    descEn: 'Convert PDF pages into JPG images.',
  ...
  },
  {
    ...
    descEn: 'Turn images into a single PDF document.',
  ...
  },
  {
    ...
    descEn: 'Extract plain text from any PDF.',
    descBn: 'যেকোনো পিডিএফ থেকে সাধারণ টেক্সট বের করুন।',
    category: 'convert',
    icon: '📝',
    functional: false,
    comingSoon: true,
  ...
  },
  {
    ...
    descEn: 'Render PDF pages as transparent PNGs.',
  ...
  },
  {
    ...
    descEn: 'Pull every embedded image out of a PDF.',
    descBn: 'পিডিএফ-এর সব এম্বেডেড ছবি বের করুন।',
    category: 'convert',
    icon: '🧩',
    functional: false,
    comingSoon: true,
  ...
  },
  {
    ...
    descEn: 'Flatten form fields & annotations into the page.',
  ...
  },
  {
    ...
    descEn: 'Fill interactive PDF form fields easily.',
  ...
  },
  {
    ...
    descEn: 'Highlight, comment & markup PDFs.',
    descBn: 'পিডিএফে হাইলাইট, কমেন্ট ও মার্কআপ করুন।',
    category: 'edit',
    icon: '🖍️',
    functional: false,
    comingSoon: true,
  },
  {
    ...
    descEn: 'Add approved/draft/confidential stamps.',
  ...
  },
  {
    ...
    descEn: 'Embed a QR code onto every page.',
