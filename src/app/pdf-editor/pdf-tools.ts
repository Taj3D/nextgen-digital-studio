...
export const PDF_TOOLS: PdfTool[] = [
  ...
  },
  {
    ...
    descEn: 'Genuine browser-rendered PDF from HTML (Chromium print engine).',
    descBn: 'HTML থেকে আসল ব্রাউজার রেন্ডারিং পিডিএফ।',
    category: 'convert',
    icon: '🌐',
    functional: true,
    status: 'AVAILABLE_NOW',
  ...
  },
  {
    ...
    descEn: 'Permanently remove sensitive text from the PDF content stream.',
    descBn: 'সংবেদনশীল টেক্সট পিডিএফ থেকে স্থায়ীভাবে মুছে ফেলুন।',
    category: 'edit',
    icon: '⬛',
    functional: true,
    status: 'AVAILABLE_NOW',
  ...
  {
    id: 'edit-text',
    nameEn: 'PDF Text Editor',
    nameBn: 'পিডিএফ টেক্সট এডিটর',
    descEn: 'Open PDF and edit text directly — click to edit, add, or delete.',
    descBn: 'পিডিএফ খুলে সরাসরি টেক্সট এডিট করুন — ক্লিক করে এডিট, যোগ বা মুছুন।',
    category: 'edit',
    icon: '🖋️',
    functional: true,
    status: 'AVAILABLE_NOW',
