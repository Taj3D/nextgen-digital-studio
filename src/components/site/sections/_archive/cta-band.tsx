  ...
  return (
    <section className="relative py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-emerald-600 via-emerald-600 to-cyan-500 px-6 py-12 shadow-2xl shadow-emerald-600/30 sm:px-12 sm:py-16">
            ...
            <div className="relative flex flex-col items-center justify-between gap-8 text-center lg:flex-row lg:text-left">
              <div className="max-w-2xl">
                ...
                <div className="mt-5 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-emerald-50/90 lg:justify-start">
              ...
              <div className="flex shrink-0 flex-col gap-3">
                <Button
                  onClick={() => openWith()}
                  size="lg"
                  className="h-14 rounded-xl bg-white px-8 text-base font-bold text-emerald-700 shadow-xl transition-transform hover:scale-[1.03]"
                >
                  Book Strategy Call
